...
user2 = User.create!(first_name: "David", last_name: "Attar", phone_number: "514-233-6553", email: "david@attar.ca", password: "mypassword", address: '5333 Avenue Casgrain Suite 102, Montréal QC')
file2 = URI.open('https://avatars.githubusercontent.com/u/93945915?v=4')
user2.photo.attach(io: file2, filename: 'dp.png', content_type: 'image/png')
