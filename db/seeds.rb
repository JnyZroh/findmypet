...
poster1 = Poster.create!(date_missing: Date.new(2022,3,1), date_found: nil, found: false, comment: "Red Husky with white ears. She's large but very friendly. She should be pretty easy to catch.", reward: 50, radius: 2, address: '5200 Avenue Casgrain, Montréal QC', pet: pet1, latitude: 45.5251471, longitude: -73.593808)
poster2 = Poster.create!(date_missing: Date.new(2022,3,2), date_found: nil, found: false, comment: "He's grey and brown, with bright green eyes and stripes. He's a housecat. A bit nervous so please approach him slowly. Lure with food, if possible.", reward: 50, radius: 2, address: '8899 Rue Berri, Montreal, Quebec', pet: pet2, latitude: 45.5470079, longitude: -73.642134)
poster3 = Poster.create!(date_missing: Date.new(2022,3,2), date_found: nil, found: false, comment: "Black with a white belly and brown eyes. He likes to hide in the bushes when he's afraid. He still has a blue and yellow leash attached.", reward: 50, radius: 2, address: '60 Avenue Roosevelt, Mount Royal, Quebec', pet: pet3, latitude: 45.514244649999995, longitude: -73.64132092053217)
poster4 = Poster.create!(date_missing: Date.new(2022,3,3), date_found: nil, found: false, comment: "A little bit feisty! Friendly but timid. And he will bite but he's small so it won't hurt!", reward: 50, radius: 2, address: '158 Rue Saint-Viateur Ouest, Montréal, QC', pet: pet4, latitude: 45.523783, longitude: -73.6006065)
...
report2.photos.attach(io: File.open(Rails.root.join('app/assets/images/Report2_Cat_field.png')),
                  filename: 'Report2_Cat_field.png')
report2.save!
...
report3.photos.attach(io: File.open(Rails.root.join('app/assets/images/Report3_Lab_Couch.jpg')),
                  filename: 'Report3_Lab_Couch.jpg')
report3.save!
...
report4.photos.attach(io: File.open(Rails.root.join('app/assets/images/Report4_Cat.png')),
                  filename: 'Report4_Cat.png')
report4.save!
