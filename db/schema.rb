...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 2022_03_07_172525) do
=======
ActiveRecord::Schema.define(version: 2022_03_07_194458) do
>>>>>>> master
  ...
  create_table "posters", force: :cascade do |t|
    ...
    t.float "latitude"
    t.float "longitude"
    t.index ["pet_id"], name: "index_posters_on_pet_id"
  end
